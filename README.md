        ...
        tailwind.config = {
            theme: {
                extend: {
                    ...
                    colors: {
                        'natural-bg': '#F9FAFB',    /* 全体の背景：さらに薄いグレーでモダンに */
                        'natural-brown': '#5D4037', /* 文字色 */
                        'brand-blue': '#4F46E5',    /* アクセントカラー（ボタンなど） */
...
<body class="font-maru text-gray-700 min-h-screen flex flex-col">
