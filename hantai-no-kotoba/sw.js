...
self.addEventListener('activate', (e) => {
  e.waitUntil(
    caches.keys().then((keys) =>
      Promise.all(keys.filter((k) => k.startsWith('hantai-no-kotoba-cache-') && k !== CACHE).map((k) => caches.delete(k)))
