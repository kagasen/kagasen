...
- 補足: このアプリだけエントリが `index.html` でなく `kanjibusyu-ta.html`（manifest の start_url・SWのnavigateフォールバックもこのファイル名を指す）。index.html 化するなら apps.js のリンクと manifest/sw.js も揃えて直すこと。
