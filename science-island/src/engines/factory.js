...
function fcSpecialArt(){
  ...
  return '<g pointer-events="none" opacity="'+fade.toFixed(2)+'">'+
    ...
    '<image href="images/recycle-transform-machine-v1.png" x="-211" y="-118" width="422" height="236" preserveAspectRatio="xMidYMid slice" opacity=".42" clip-path="url(#fc-special-clip)"/><rect x="-211" y="-118" width="422" height="236" rx="28" fill="#05283C" opacity=".5"/>'+
...
function fcRescueArt(){
  ...
  return '<g pointer-events="none" opacity="'+fade.toFixed(2)+'"><g transform="translate(300,358) scale('+pop.toFixed(2)+')" filter="url(#fc-card-shadow)">'+
    ...
    '<image href="images/recycle-transform-machine-v1.png" x="-195" y="-98" width="390" height="196" preserveAspectRatio="xMidYMid slice" opacity=".2" clip-path="url(#fc-rescue-clip)"/>'+
