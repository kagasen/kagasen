...
const ASSETS = [
  ...
  './index.html',
  './images/pets/angel-egg.png',
  './images/pets/angel-baby.png',
  './images/pets/angel-teen.png',
  './images/pets/angel-adult.png',
  './images/pets/bunny-egg.png',
  './images/pets/bunny-baby.png',
  './images/pets/bunny-teen.png',
  './images/pets/bunny-adult.png',
  './images/pets/cat-egg.png',
  './images/pets/cat-baby.png',
  './images/pets/cat-teen.png',
  './images/pets/cat-adult.png',
  './images/pets/chick-egg.png',
  './images/pets/chick-baby.png',
  './images/pets/chick-teen.png',
  './images/pets/chick-adult.png',
  './images/pets/dino-egg.png',
  './images/pets/dino-baby.png',
  './images/pets/dino-teen.png',
  './images/pets/dino-adult.png',
  './images/pets/dragon-egg.png',
  './images/pets/dragon-baby.png',
  './images/pets/dragon-teen.png',
  './images/pets/dragon-adult.png',
  './images/pets/fox-egg.png',
  './images/pets/fox-baby.png',
  './images/pets/fox-teen.png',
  './images/pets/fox-adult.png',
  './images/pets/owl-egg.png',
  './images/pets/owl-baby.png',
  './images/pets/owl-teen.png',
  './images/pets/owl-adult.png',
  './images/pets/penguin-egg.png',
  './images/pets/penguin-baby.png',
  './images/pets/penguin-teen.png',
  './images/pets/penguin-adult.png',
  './nagare2nen.html',
  './nagare3nen.html',
  './nagare4nen.html',
  './nagare5nen.html',
